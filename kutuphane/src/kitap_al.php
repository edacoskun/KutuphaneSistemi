    ...
    <h3>ÜYE LİSTESİ</h3> 
        ...
        ?>
               <tr>
                    ...
                    <td>
                        <?php if($row["durum"] == 1){
                            echo "Kitap zaten mevcut";
                        }
                        else{
                        
                    $kitap="SELECT * FROM emanet WHERE uye_id=".$row["uye_id"]."";
                    ...
                    $gelen=mysqli_fetch_array($cevap);
                            ...
                            <button class="buton" type="button" style="background-color: #6495ed;">
                            <a href="emanet_al.php?uye_id=<?= $row["uye_id"]; ?>&kitap_id=<?= $gelen["kitap_id"]; ?>" >
                               <font color="white"> <b>Kitabı geri al</b></font> 
                            </a></button>
                        <?php } ?> 
                </tr>
            <?php } ?>
