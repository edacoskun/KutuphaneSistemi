...
echo "<tr><th>Yazar ID</th><th>Adı</th><th>Soyadı</th><th>Sil</th></tr>";
...
while($gelen=mysqli_fetch_array($cevap))
{
    ...
    echo "<td><button type='button' style='background-color: #6495ed;'><a href='yazar_sil.php?id=" .$gelen['yazar_id']. "'>SİL</a></button></td>";
