        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><button type="button" style="background-color: #6495ed;"><a href="kitap_sil.php?id=<?= $row["kitap_id"]; ?>">SİL</a></button></td>
                    
                    <td>
                    <?php
                        if($row['stok'] > 0){ ?>
                            <button type="button" style="background-color: #6495ed;"><a href="kitap_ver.php?id=<?= $row["kitap_id"]; ?>">KİTAP VER</a></button>
                            <td><button type="button" style="background-color: #6495ed;"><a href="kitap_al.php?id=<?= $row["kitap_id"]; ?>">KİTAP AL</a></button></td>
                            <?php }
                            else {
                                echo "Kitap stoklarda yok!";
                            } ?>
                    </td>
                </tr>
            <?php } ?>
